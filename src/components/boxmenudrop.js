    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <a className="drop-link" href="mailto:ysshalini911@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/YSShalini">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/shalini-y-s-bb269b23b/">
            <img
              src={li}
              alt=""
            />
